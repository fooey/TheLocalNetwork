...
<cfif structKeyExists(url, "submit")>
	...
	<cfset emailSettings = {
		to="feedback@the-local-network.com", 
		from="feedback@the-local-network.com" ,
		subject="TLN Feedback: #htmlEditFormat(form.subject)#", 
		replyto="#htmlEditFormat(form.email)#", 
		type="html"
	} />
	<cfmail attributecollection="#emailSettings#"><cfoutput>#emailContent#</cfoutput></cfmail>
